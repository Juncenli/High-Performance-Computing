    ...
    for epoch in range(total_epoch):
        ...
        if best_test_acc < float(test_accuracy):
            ...
            if not os.path.isdir('./model'):
                os.mkdir('./model')
            torch.save(net.state_dict(), "./model/KMNIST_resnet18_CNN.ckpt")
    
    end = time.time();
    print("The training time of KMNIST resnet18 pytorch is:", end-start,"(seconds)")
    print('Model saved in file: ./model/KMNIST_resnet18_CNN.ckpt')
