    ...
    for epoch in range(total_epoch):
        ...
        if best_test_acc < float(test_accuracy):
            ...
            if not os.path.isdir('./model'):
                os.mkdir('./model')
            torch.save(net.state_dict(), "./model/MNIST_resnet18_CNN.ckpt")
    
    end = time.time();
    print("The training time of MNIST resnet18 pytorch is:", end-start,"(seconds)")
    print('Model saved in file: ./model/MNIST_resnet18_CNN.ckpt')
